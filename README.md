...
## Version 3.0.0 - Complete ESLint 9 Migration ✨
...
- **🔧 No Deprecated Rules**: Removed `indent`, `max-len` and other deprecated formatting rules
...
ESLint 9 removed formatting rules like `indent` and `max-len`. If you need them:
